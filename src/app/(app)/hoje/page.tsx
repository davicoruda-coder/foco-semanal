            ...
            <div className="divide-y divide-[var(--line)] md:hidden">
              {subjects.map((s) => (
                ...
                >
                  ...
                  <textarea
                    className="min-h-12 w-full resize-y rounded-[var(--radius-tag)] border border-[var(--line)] bg-[var(--surface)]/70 px-2.5 py-2 text-[15px] outline-none focus:border-[var(--signal)]"
                    value={s.notes}
                ...
                <tbody>
                  {subjects.map((s, i) => (
                    ...
                    >
                      ...
                      >
                        <textarea
                          className="min-h-[1.5rem] w-full resize-y break-words rounded-[var(--radius-tag)] border border-transparent bg-transparent px-0 py-0 text-[15px] font-normal leading-snug outline-none focus:border-[var(--line)] focus:bg-[var(--surface)] focus:px-2 focus:py-1.5"
                          rows={1}
                          value={s.notes}
                          placeholder="Anotações…"
                          onChange={(e) =>
